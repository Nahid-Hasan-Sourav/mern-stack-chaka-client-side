    ...
    return (
     ...
     <div className="flex justify-center">
        ...
        <div className="card flex-row flex-shrink-0 lg:w-6/12 w-[100%] shadow-2xl bg-base-100">
          <form onSubmit={handleSubmit(handleAddProductSubmit)} className="card-body">
           ...
           <div className="form-control">
            ...
            <div className="form-control w-full ">
              ...
              <select className="select select-bordered" name='productCondition'  {...register("productCondition", { required: true })}>
            ...
            <div className="form-control w-full">
              ...
              <select className="select select-bordered" name='productCategory'  {...register("FuelType", { required: true })}>
                <option value="Diesel" >
                 Diesel
                </option>
                <option  value="Octane" slected>Octane</option>
                <option  value="Cng">Cng</option>
                <option  value="Petroll" slected>Petroll</option>
                <option  value="Cng">Cng</option>
              </select>
            </div>
            ...
            <div className="form-control w-full">
              ...
              <select className="select select-bordered" name='productCategory'  {...register("productCategory", { required: true })}>
                <option value="Off Roader" >
                 Off Roader
                </option>
                <option  value="Pickup" slected>Pickup</option>
                <option  value="Wagon">Wagon</option>
              </select>
            </div>
            <textarea className="textarea textarea-bordered" name='productDescription' placeholder="About Your Products"  {...register("description", { required: true })}></textarea>
